...
public class ImageEncrypter {
    ...
    public static BufferedImage encrypt(BufferedImage container, String message) {
        ...
        for (int y = 0; y < containerHeight; y++) {
            for (int x = 0; x < containerWidth - 1; x += 2) {
                ...
                char currentChar = message.charAt(pixelsCounter);
                ...
                if (pixelsCounter >= message.length()) {
